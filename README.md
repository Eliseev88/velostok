...
Веб-витрина по каталогу из **17 932 товаров** в четырёх разделах: **16 176 велосипедов**,
**1 016 запчастей**, **519 аксессуаров** и **221 позиция экипировки** — с ценами,
...
| Брендов | 29 |
| Характеристик | 2 210 |
| Ссылок на фото | 1 640 |

Крупнейшие категории — шлемы (79), банданы и шапки (41), перчатки (38), велорюкзаки (21).
У шести позиций `category` пуст: сайт не привязал их к категории каталога, хотя цены,
фото и характеристики у них на месте.
